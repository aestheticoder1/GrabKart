...
// Since the request is a GET, sending userId or guestId in req.query
// follows best practices. If we used a POST request
// (which is not ideal for retrieval), then we could send these
